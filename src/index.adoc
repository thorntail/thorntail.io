...
<div class="purchase">
  <div class="container overflow-h">
    <div class="row">
      <span>
      Thorntail has <a href="/posts/the-end-of-an-era">announced end of life</a>.
      Everything else on this site is now outdated.
      We recommend using <a href="https://quarkus.io/">Quarkus</a> or <a href="https://wildfly.org/">WildFly</a>.
      </span>
    </div>
